...
DEFAULT_ACTION_PLUGIN_PATH     = shell_expand_path(get_config(p, DEFAULTS, 'action_plugins',     None, os.path.join(DEFAULT_PLUGINS_PATH, 'action_plugins')))
DEFAULT_CALLBACK_PLUGIN_PATH   = shell_expand_path(get_config(p, DEFAULTS, 'callback_plugins',   None, os.path.join(DEFAULT_PLUGINS_PATH, 'callback_plugins')))
DEFAULT_CONNECTION_PLUGIN_PATH = shell_expand_path(get_config(p, DEFAULTS, 'connection_plugins', None, os.path.join(DEFAULT_PLUGINS_PATH, 'connection_plugins')))
DEFAULT_LOOKUP_PLUGIN_PATH     = shell_expand_path(get_config(p, DEFAULTS, 'lookup_plugins',     None, os.path.join(DEFAULT_PLUGINS_PATH, 'lookup_plugins')))
DEFAULT_VARS_PLUGIN_PATH       = shell_expand_path(get_config(p, DEFAULTS, 'vars_plugins',       None, os.path.join(DEFAULT_PLUGINS_PATH, 'vars_plugins')))
DEFAULT_FILTER_PLUGIN_PATH     = shell_expand_path(get_config(p, DEFAULTS, 'filter_plugins',     None, os.path.join(DEFAULT_PLUGINS_PATH, 'filter_plugins')))
